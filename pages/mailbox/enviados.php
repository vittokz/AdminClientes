          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <tbody>
                  <?php
                     $sql=mysqli_query($conexion,"SELECT * FROM des_email where remitente like '$usuario' order by fechaRegistro DESC");
                       while($row=mysqli_fetch_assoc($sql)) 
                        {
                            $idEmail = $row["idEmail"];
                            $asunto= $row["asunto"];
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="leerMensajeEnviado.php?idEmail=<?php echo $idEmail;?>"><?php echo $asunto;?></a></td>
