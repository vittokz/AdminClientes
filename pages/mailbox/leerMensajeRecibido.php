<?php require_once("../../seguridad/seguridad.php");
    ...
    $sql=mysqli_query($conexion,"SELECT * FROM des_email where idEmail like '$idEmail'");
                       while($row=mysqli_fetch_assoc($sql)) 
                        {
                            $asunto= $row["asunto"];
    ...
    $sql=mysqli_query($conexion,"UPDATE des_email set estado='Leido' where idEmail like '$idEmail'");
?>
...
<div class="wrapper"  >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Correo-Leer</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="mailbox.php" style="background-color:#1d1a31" class="btn btn-primary btn-block margin-bottom">Volver Bandeja de Entrada</a>
           ...
           <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="mailbox.php"><i class="fa fa-inbox"></i> Bandeja de Entrada
                      <span class="label label-primary pull-right"></span></a></li>
                    <li class="active"><a href="enviados.php"><i class="fa fa-envelope-o"></i> Enviados</a></li>
                  </ul>
                </div>
              <!-- /.box-body -->
            </div>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Email Recibido</h3>
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>Para: <?php echo $destinatario;?>
                  <span class="mailbox-read-time pull-right"> <?php echo $fechaRegistro;?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              ...
              <ul class="mailbox-attachments clearfix">
                <li>
                  ...
                  <div class="mailbox-attachment-info">
                    <a href="ArchivosCorreos/<?php echo $usuario;?>/<?php echo $archivoAdjunto;?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>  <?php echo $archivoAdjunto;?></a>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="registrarCorreo.php?asunto=<?php echo $asunto;?>&mensaje=<?php echo $mensaje;?>" type="button" class="btn btn-default"><i class="fa fa-reply"></i> 
                Reenviar</a>
              </div>
