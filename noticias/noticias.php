  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Noticias Viacpro</h1><br>
        <div class="row">
        <!-- left column -->
        <?php
          $sql="SELECT * FROM des_noticias where estado like 'Activo' order by fechaRegistro ASC";
          $resul = mysqli_query($conexion,$sql);
               while($row=mysqli_fetch_assoc($resul)) {  
                   $nomNoticia = $row["nombre"];  
                   $desNoticia = $row["descripcion"]; 
                ...
                <div class="col-md-4">
                    ...
                    <!-- Add the bg color to the header using any of the bg-* classes -->
                        <div class="widget-user-header bg-aqua-active" style="background-image:url('../img/azulOscuro.png')">
                          <h3 class="widget-user-username">VIACPRO</h3>
                          <h5 class="widget-user-desc"><?php echo $nomNoticia;?></h5>
                        </div>
                                    ...
                                    <div class="row">
                                            <div class="col-sm-12 border-right">
                                                    <div class="description-block">
                                                         <hr>
                                                         <?php echo $desNoticia;?><br>
                                                          <img src="../../AdminDespacho/noticias/noticias/<?php echo $nombreArchivo;?>" width="30%">
                                                    </div>
                                              <!-- /.description-block -->
                                            </div>
                                      <!-- /.col -->
