          ...
          <div class="box box-primary">
             ...
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php
				        $nomDoc ="";$estado="";$fechaRegistro = "";
						    $sql=mysqli_query($conexion,"SELECT * FROM des_documentos where identidad like '$identidad' 
                          ...
                          <tr>
                            <th><?php echo $nombre;?></th>
                             ...
                             <th><a target="_blank" href="../../AdminDespacho/documentos/Documentos/proceso<?php echo $identidad;?>/<?php echo $nombre;?>">Ver</a></th> 
               ...
               <table class="table table-hover">
                ...
                <?php
						    ...
						    $sql=mysqli_query($conexion,"SELECT * FROM des_liquidar_contratos where idenCliente like '$identidad' 
						  	order by fechaRegistro ASC");
								while($row=mysqli_fetch_assoc($sql)) {
									$periodoInicial = $row["periodoInicial"];
							    $periodoFin = $row["periodoFin"];
									$idLiquida = $row["idLiquida"];
						
			          	?>
                          <tr>
                            <th><?php echo $idLiquida;?></th>
                             <th><?php echo $periodoInicial." - ".$periodoFin;?></th> 
                             <th><a target="_blank" href="../../AdminDespacho/factura/pdfFacturas/<?php echo $identidad;?>/<?php echo $idLiquida;?>">Ver</a></th> 
