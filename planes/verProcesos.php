...
<head> <meta charset="utf-8">
  ...
  <title>.::Procesos por Planes::.</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Procesos Plan <?php echo strtoupper($muni); ?></h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
      ...
      $sql="SELECT * FROM des_procesos where idCliente like '$identidad' and idContrato like '$idContrato'";
   
      $resul=mysqli_query($conexion,$sql);
			 while($row=mysqli_fetch_assoc($resul)) {
        $idProceso = $row["idProceso"];
        $idRadicado = $row["idRadicado"];
        ...
        mysqli_free_result($sqlProceso);
				...
				?>
                  <tr style="font-size:11px">
                      ...
                      <th><?php echo  strtoupper($nomJuzgado);?></th>
                      <th><?php echo $fechaProceso;?></th>
    
                      <th><a href="verProcesoSeleccionado.php?idProceso=<?php echo $idProceso;?>&municipio=<?php echo $muni;?>">
                      <img  src='../img/ver.png' width='35' height='25' title="Ver Información"></a></th>
                  </tr>
               <?php
				     }
