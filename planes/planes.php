...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      $sql="SELECT * FROM des_contratos_empresas where identidad like '$identidad'";
      ...
      $resul=mysqli_query($conexion,$sql);
        ...
        //verifico nombre del plan
        $sqlPlan=mysqli_query($conexion,"SELECT * FROM des_planes where estado like 'Activo' and idPlan like '$idPlan' order by idPlan ASC ");
		                while($rowP=mysqli_fetch_assoc($sqlPlan)) {
                         $idPlan = $rowP["idPlan"];
                  ...
                  <tr style="font-size:11px">
                      ...
                      <th>
                        <?php 
                           ...
                           $nombreCiudad="";
                           $sqlCiudad=mysqli_query($conexion,"SELECT * FROM lista_estados where id like '$municipio'");
                      ...
                      <?php
                        if($Estado=="Activo"){
                      ?>
                      <th><a href="verProcesos.php?idContrato=<?php echo $idContrato; ?>&muni=<?php echo $nombreCiudad;?>&descrip=<?php echo $descripcion;?>">
                      <img  src='../img/ver.png' width='35' height='25' title="Ver Procesos"></a>
                      <?php
                      }
                      else{
                      ?>
                         <th><a href="inactividad.php?idContrato=<?php echo $idContrato; ?>&muni=<?php echo $nombreCiudad;?>&descrip=<?php echo $descripcion;?>">
                      <img  src='../img/ver.png' width='35' height='25' title="Inactivo"></a>
                      <?php
                      }
                      ?>
                      </th>
