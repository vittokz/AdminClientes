             ...
             <h3>Listado de Estados</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size:12px">
                  ...
                  <th align="right"><a href="../../AdminDespacho/procesos/imgProcesos/proceso<?php echo $idProceso;?>/actuaciones/<?php echo $nombreArchivo;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=330pt,top=50pt,width=700px,height=550px'); return false;">
			...
			?>
              ...
              <?php
		       ...
		       $resulO=mysqli_query($conexion,$sqlO) or die ("No hay datos");
		   ?>
        ...
        <div class="table-responsive">
             <h3>Listado de Oficios/Otros</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 <?php
                      while($rowO = mysqli_fetch_assoc($resulO)){
                ...
                <tr style="font-size:12px">
                  ...
                  <th align="right"><a href="../../AdminDespacho/procesos/imgProcesos/proceso<?php echo $idProceso;?>/oficios/<?php echo $nombreArchivo;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=330pt,top=50pt,width=700px,height=550px'); return false;">
                 <img  src='../img/ver.png' width='32' height='26' title="Ver archivo"></a>
                    </th>
		   ...
		   ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size:12px">
                  ...
                  <th align="right"><a href="../../AdminDespacho/procesos/imgProcesos/proceso<?php echo $idProceso;?>/multimedia/<?php echo $nombreArchivo;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=330pt,top=50pt,width=700px,height=550px'); return false;">
                 <img  src='../img/ver.png' width='32' height='26' title="Ver archivo"></a>
                    </th>
