...
<head>
  ...
  <title>.::Buscar por municipio::.</title>
  ...
  <div class="box">
   <div class="box-body table-responsive no-padding">
             ...
             <?php
				  ...
				  $sqlJ=mysqli_query($conexion,"SELECT * FROM des_juzgados where ciudad like '$municipio'");
			...
			?>
              <tr>
                  ...
                  <td style="font-size:16px"><a href="procesoSeleccionado.php?idProceso=<?php echo $idProceso;?>&identidad=<?php echo $idCliente;?>">
