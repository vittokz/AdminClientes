<?php require_once("../seguridad/seguridad.php");
     ...
     if(!isset($_SESSION)) { session_start(); } 
       ...
       $sql=mysqli_query($conexion,"SELECT tipo_usuario FROM des_usuario WHERE nombre_usua like '$usuario' and estado_usuario like 'Activo'");
		...
		$sqlProceso=mysqli_query($conexion,"SELECT * FROM des_procesos WHERE demandante like '%$demandante%'");
		...
		if($ban==0){
			echo "<CENTER><br><p style='font-size:18px; color:RED'>Nombre del Demandante no existe!!!</p></CENTER>";
   ...
   <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td style="font-weight:800"><?php echo strtoupper($demandante);?></td>
