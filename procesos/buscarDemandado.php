...
<head>
  ...
  <title>.::Procesos por Demandado::.</title>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Nombre del Demandado</h3>
               ...
               <form name="busqueda">
            	 <div class="box-body table-responsive no-padding">
                      ...
                      <tr>
                        ...
                        <th><button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="buscarDemandado(); return false;">Buscar</button></th>
