...
<head>
  ...
  <title>.::Audios Videos de Audiencias::.</title>
        ...
        <div class="col-md-12">
         ...
         <div class="box-body table-responsive no-padding">
          ...
          <div class="box">
           <div class="box-body">
           <?php
		     $fecha="";$detalle ="";$tipo ="";$nombreArchivo ="";
    $sqlA="SELECT * FROM des_audiosvideos WHERE idProceso like '$idProceso' order by fechaRegistro DESC";
    echo $sqlA;
         ...
         <div class="table-responsive">
             <h3>Listado de Audios/Videos</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
				 while($rowA=mysqli_fetch_assoc($resul)) {
				    $fecha = $rowA["fecha"];
					$tipo = $rowA["tipo"];
					$detalle = $rowA["detalle"];
				...
				?>
                  <tr style="font-size:11px">
                   ...
                   <td>
                    <a href="../../AdminDespacho/procesos/imgProcesos/proceso<?php echo $idProceso;?>/multimedia/<?php echo $nombreArchivo;?>"target="_blank"
