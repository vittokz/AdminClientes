       ...
       <div class="col-md-9">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Actuaciones del dia</h3>
            ...
            <div class="box-footer table-responsive no-padding">
             <?php
			  ...
			  // $hoy = $hoy." 1:00 am";
			   $fin = date("Y-m-d"); 
			  // $fin = $fin." 11:59 pm";
			  $sql="select * from des_actuaciones where idCliente like '$identidad' and fechaInicio = '$hoy' order by fechaRegistro";
			  $res=mysqli_query($conexion,$sql);
       ...
       <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <a href="index.php" target="popup" style="text-decoration:none; color:#FFF"
       ...
       <div class="col-md-12">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header" style="background:#1d1a31; color:#FFF">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">
              <span class="parpadea text"><strong>Actuaciones Proximas a vencer</strong>
             </h3>
              <h5 class="widget-user-desc">Listado</h5>
            </div>
            <div class="box-footer table-responsive no-padding">
       ...
       <div class="col-md-12">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header" style="background:#1d1a31; color:#FFF">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">
              <span class="parpadea text"><strong>Oficios Proximas a vencer</strong>
             </h3>
              <h5 class="widget-user-desc">Listado</h5>
            </div>
            <div class="box-footer table-responsive no-padding">
             <?php
			  ...
			  $sql="select * from des_oficios where idCliente like '$identidad' and fechaFin BETWEEN '$hoy' and '$nuevafecha' order by fechaFin";
        $res=mysqli_query($conexion,$sql);
        $registrosCe=mysqli_num_rows($res);
             ...
             <?php
			   ...
			   while($rowA=mysqli_fetch_assoc($res)){
				   ...
				   $fechaInicio=$rowA["fecha"];		
           $fechaFin=$rowA["fechaFin"];		   
           $descripcion=$rowA["descripcion"];	
			 ?>
              <tr style="color:#000; background:#FF9; font-weight:800">
                
                <td><a href=""><?php echo strtoupper(substr($descripcion,0, 40)); ?></a></td>
                <td><a href=""><?php echo $fechaInicio;?></a></td>
                <td><a href=""><?php echo $fechaFin;?></a></td>
                <td><a target="_blank" href="../../AdminDespacho/procesos/imgProcesos/proceso<?php echo $idProceso;?>/oficios/<?php echo $nombreArchivo;?>">VER</a></td>
              </tr>
			<?php
			   }
			 ?>
       ...
       <div class="col-md-12" >
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header" style="background:#900; color:#FFF">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Actuaciones Vencidas (Hace 5 dias)</h3>
              <h5 class="widget-user-desc">Listado</h5>
            </div>
            <div class="box-footer table-responsive no-padding">
             <?php
