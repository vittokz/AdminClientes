<?php
			...
			VALUES ('$nombre','$email','$tel','$ciudad','Dependiente','$semestre','','',now())";
			...
			*/
			...
			$asunto = "Solicitud VIACPRO-Registro con exito Informacion Dependiente Judicial"; 
         	//para el envío en formato HTML 
			$headers = "MIME-Version: 1.0\r\n"; 
			$headers .= "Content-type: text/html; charset=iso-8859-1\r\n"; 
			...
			$headers .= "Telefono : ".$tel."<br>";
			$headers .= "Ciudad : ".$ciudad."<br>";
			$headers .= "Semestre : ".$semestre."<br><br>";
