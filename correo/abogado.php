<?php
			...
			VALUES ('$nombre','$email','$tel','$ciudad','Abogado','','$estudios','$nomEstudio',now())";
			mysqli_query($conexion,$sql) or die ("No se inserto:".mysqli_error());

			$asunto = "Solicitud VIACPRO-Registro con exito Informacion Profesional Abogado"; 
			...
			$headers .= "Estudios : ".$estudios."<br>";
			$headers .= "Nombre Estudio : ".$nomEstudio."<br>";
